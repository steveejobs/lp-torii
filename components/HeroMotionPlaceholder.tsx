...
const frames = [
  ...
  {
    src: images.prato1,
    alt: "Pratos japoneses do Torii em composição editorial",
...
export function HeroMotionPlaceholder() {
  return (
    <div className="relative mx-auto w-full max-w-[560px] overflow-hidden rounded-lg border border-black/10 bg-white shadow-[0_28px_80px_rgba(16,16,16,0.12)]">
      ...
      <div className="absolute left-5 top-7 z-20 h-px w-32 origin-left bg-black animate-[lineSweep_4.5s_ease-in-out_infinite] md:left-8 md:w-56" />
      <div className="absolute bottom-8 right-7 z-20 h-px w-28 origin-left bg-black/80 animate-[lineSweep_5.4s_ease-in-out_infinite] md:w-44" />
      ...
      <div className="absolute bottom-0 left-0 right-0 z-30 border-t border-white/20 bg-black/54 px-5 py-4 text-white backdrop-blur-md md:px-7">
        <div className="flex items-center justify-between gap-4">
          <p className="text-sm font-extrabold md:text-base">Salão, cozinha e fachada</p>
          <span className="h-2 w-10 rounded-full bg-[var(--torii-red)]" aria-hidden="true" />
        </div>
      </div>
    </div>
  );
